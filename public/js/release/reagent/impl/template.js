...
var G__25820 = o;
goog.object.set(G__25820,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__25821__delegate = function (args){
...
return G__25821__delegate.call(this,args);};
...
return G__25821__delegate(args);
});
...
var G__25824 = o;
goog.object.set(G__25824,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__25825__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__25825 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__25826__i = 0, G__25826__a = new Array(arguments.length -  0);
while (G__25826__i < G__25826__a.length) {G__25826__a[G__25826__i] = arguments[G__25826__i + 0]; ++G__25826__i;}
  args = new cljs.core.IndexedSeq(G__25826__a,0,null);
} 
return G__25825__delegate.call(this,args);};
G__25825.cljs$lang$maxFixedArity = 0;
G__25825.cljs$lang$applyTo = (function (arglist__25827){
var args = cljs.core.seq(arglist__25827);
return G__25825__delegate(args);
});
...
var G__25828 = props;
var G__25828__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__25828,cljs.core.cst$kw$id,id):G__25828);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__25828__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__25828__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__25829 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__25829,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__25829;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__25830){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25831__$1,cljs.core.cst$kw$on_DASH_write);
...
return (jsprops.onChange = (function (p1__25833_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__25833_SHARP_);
}));
} else {
return null;
}
...
var vec__25836 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25836,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25836,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25836,(2),null);
...
var temp__5739__auto___25840 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___25840 == null)){
} else {
var key_25841 = temp__5739__auto___25840;
(jsprops.key = key_25841);
}
...
var temp__5739__auto___25842 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___25842 == null)){
} else {
var key_25843 = temp__5739__auto___25842;
(jsprops.key = key_25843);
}
...
var G__25844 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__25844) : reagent.impl.template.as_element.call(null,G__25844));
} else {
var temp__5739__auto___25845 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___25845 == null)){
} else {
var key_25846 = temp__5739__auto___25845;
(jsprops.key = key_25846);
}
...
var G__25848 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__25848)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__25848)){
return x;
} else {
...
var len__4789__auto___25851 = arguments.length;
var i__4790__auto___25852 = (0);
while(true){
if((i__4790__auto___25852 < len__4789__auto___25851)){
args__4795__auto__.push((arguments[i__4790__auto___25852]));

var G__25853 = (i__4790__auto___25852 + (1));
i__4790__auto___25852 = G__25853;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq25849){
var G__25850 = cljs.core.first(seq25849);
var seq25849__$1 = cljs.core.next(seq25849);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25850,seq25849__$1);
}));
...
break;
default:
var G__25856 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__25856;
continue;
...
var ctx = ({});
var vec__25858 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25858,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25858,(1),null);
...
var G__25861 = (cljs.core.count(argv) - first_child);
switch (G__25861) {
case (0):
...
break;
case (1):
var G__25862 = component;
var G__25863 = jsprops;
var G__25864 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__25862,G__25863,G__25864);
